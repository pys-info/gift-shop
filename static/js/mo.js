  ...
  return (function (t) {
    ...
    function (t, e, r) {
      ...
      t.exports = function (t, e) {
        if (!i(t)) return t;
        var r, s;
        if (e && "function" == typeof (r = t.toString) && !i((s = r.call(t))))
          return s;
    ...
    function (t, e, r) {
      ...
      var i = r(13),
        ...
        K = function (t) {
          ...
          return (
            !(this === U && s(Y, t) && !s(X, t)) &&
            (!(e || !s(this, t) || !s(Y, t) || (s(this, R) && this[R][t])) || e)
          );
        },
        Q = function (t, e) {
          if (((t = w(t)), (e = b(e, !0)), t !== U || !s(Y, e) || s(X, e))) {
            var r = k(t, e);
            return (
              !r || !s(Y, e) || (s(t, R) && t[R][e]) || (r.enumerable = !0), r
            );
          }
        },
        Z = function (t) {
          ...
          o(
            ...
            "JSON",
            {
              stringify: function (t) {
                if (void 0 !== t && !V(t)) {
                  for (var e, r, i = [t], s = 1; arguments.length > s; )
                    i.push(arguments[s++]);
                  return (
        ...
        return (
              ...
              ? ((t.unit = e.unit),
                ...
                this.warn(
                  'Two different units were specified on "' +
                    r +
                    '" delta property, mo Â· js will fallback to end "' +
                    e.unit +
                    '" unit '
                ))
              : void 0;
          ...
          (t.prototype.delta = function (t, e) {
            ...
            if (
              ((o = typeof e),
              (r =
                "string" === (n = typeof t) || ("number" === n && !isNaN(t))),
            ...
            (e.prototype.castStrokeDash = function (t) {
              ...
              if (u.default.isArray(e[t])) {
                for (var r = "", i = 0; i < e[t].length; i++) {
                  var n = e[t][i];
                  r +=
                    ("%" === n.unit ? this.castPercent(n.value) : n.value) +
                    " ";
                }
        ...
        a = (function () {
          ...
          return (
            ...
            (t.prototype._setProp = function (t, e) {
              if ("object" === (void 0 === t ? "undefined" : (0, s.default)(t)))
            ...
            (t.prototype._hide = function () {
              this.el &&
                (this._props.isSoftHide
                  ? o.default.setPrefixedStyle(this.el, "transform", "scale(0)")
            ...
            (t.prototype._getDelta = function (t, e) {
              ...
              if (
                ...
                null != (r = o.default.parseDelta(t, e, this._index)).type &&
                  (this._deltas[t] = r);
                var i =
            ...
            (t.prototype._calcCurrentProps = function (t, e) {
              for (var r in this._deltas) {
                ...
                if ("array" === i.type) {
                  ...
                  if (s) {
                    var v = i.curve(e);
                    (f = parseInt(v * (i.start.r + e * i.delta.r), 10)),
                      (d = parseInt(v * (i.start.g + e * i.delta.g), 10)),
          ...
          return (
            ...
            (e.prototype._draw = function () {
              ...
              if (
                ...
                for (
                  t = "", r = p = 0, u = (_ = this._radialPoints).length;
                  p < u;
                  r = ++p
                )
                  (h = _[r]),
          ...
          return (
            ...
            (e.prototype._resetMergedFlags = function (t) {
              return (
                ...
                (t.prevChainModule = u.default.getLastItem(this._modules)),
                (t.masterModule = this),
                t
              );
            }),
            ...
            (e.prototype._mergeThenProperty = function (t, e, r) {
              var i,
                s,
                n = "boolean" == typeof r;
              if (u.default.isTweenProp(t) || this._nonMergeProps[t] || n)
                return r;
              if (
          ...
          return (
            ...
            (e.prototype._setSelfName = function () {
              ...
              (a.default[t] = null == a.default[t] ? 1 : ++a.default[t]),
                (this._props.name = this._props.nameBase + " " + a.default[t]);
            }),
            ...
            (e.prototype._extendDefaults = function () {
              ...
              (e.easing = p.default.parseEasing(e.easing)),
                ...
                null != e.backwardEasing &&
                  ((e.backwardEasing = p.default.parseEasing(e.backwardEasing)),
                ...
                t > this._prevTime &&
                  ...
                  t > this._prevTime
                    ? (0 === f && this._repeatStart(t, l),
                      t !== e.endTime && this._setProgress(l ? 1 - f : f, t, l))
                    : (t !== e.endTime &&
              ...
              (t.prototype.generate = function (t, r, i, s) {
                ...
                return t < 0 || t > 1 || i < 0 || i > 1
                  ...
                  : (4,
                    ...
                    (c = function () {
                      for (v = 0; v < 11; ) (g[v] = h(0.1 * v, t, i)), ++v;
                    }),
                    (l = function (e, r, s) {
                      var n, o;
        ...
        (i = (function () {
          ...
          return (
            ...
            (t.prototype._checkIfBoundsCloseEnough = function (t, e) {
              ...
              return (
                void 0,
                null != (r = this._checkIfPointCloseEnough(t, e.start.point))
                  ? r
            ...
            (t.prototype._normalizePath = function (t) {
              ...
              return (
                ...
                (r = i.length - 1),
                (i[r] = this._normalizeSegment(i[r], this._rect || 100)),
            ...
            (t.prototype._normalizeSegment = function (t, e) {
              ...
              if (
                ...
                for (t = "", s[0] = e, r = i = 0, n = a.length; i < n; r = ++i)
                  (p = a[r]),
                    (t += "" + (0 === r ? "" : " ") + p[0] + "," + p[1]);
              return t;
            }),
    ...
    function (t, e) {
      ...
      (i = null),
        ...
        (n = function () {
          var t;
          return (
            (t = 1 <= arguments.length ? p.call(arguments, 0) : []).length > 1
              ? (t = t.sort(a))
              : (t[0].value = o(t[0])),
            function (e) {
              var r, i;
          ...
          function e() {
            var r =
              arguments.length > 0 && void 0 !== arguments[0]
                ...
                : {};
            return (
              (0, n.default)(this, e), (0, o.default)(this, t.call(this, r))
            );
          }
          return (
            (0, a.default)(e, t),
          ...
          return (
            ...
            (e.prototype._transformHistoryRecord = function (t, e, r, i, s) {
              ...
              var n = i[e],
                o = null == s ? null : s[e];
              if (0 === t) {
                if (((i[e] = r), p.default.isTweenProp(e) && "duration" !== e))
                  return null;
              ...
              if (this._isDelta(n)) {
                var l;
                return (
                  (i[e] = ((l = {}), (l[r] = p.default.getDeltaEnd(n)), l)),
                  null
                );
              }
            ...
            (e.prototype._isRewriteNext = function (t, e) {
              ...
              return (
                this._isDelta(t) && i
                  ? p.default.getDeltaEnd(t) == p.default.getDeltaStart(e) &&
                    (n = !0)
          ...
          return (
            ...
            (e.prototype._calcPosData = function () {
              var t = this._getPosValue("x"),
                ...
                r =
                  90 + Math.atan(e.delta / t.delta || 0) * p.default.RAD_TO_DEG;
              this._posData = {
          ...
          return (
            ...
            (e.prototype._extendDefaults = function () {
              ...
              for (var e = (0, p.default)(t), r = 0; r < e.length; r++) {
                var i = e[r],
                  n =
                    !this._drawExclude[i] && null == this._defaults[i] && !y[i],
            ...
            (e.prototype._saveCustomProperties = function () {
              ...
              (this._customProps = t.customProperties || {}),
                (this._customProps = (0, s.default)({}, this._customProps)),
            ...
            (e.prototype._mergeThenProperty = function (t, e, r) {
              ...
              if (c.isObject(r) && null != r.to) {
                for (var o in r)
                  (y[o] || "curve" === o) && ((n[o] = r[o]), delete r[o]);
                r = r.to;
              }
              if (this._isDelta(r)) {
                var a = {};
                for (var p in r)
                  (y[p] || "curve" === p) && ((a[p] = r[p]), delete r[p]);
    ...
    function (t, e, r) {
      ...
      t.exports =
        ...
        r(23)(function () {
          ...
          ? function (t, e) {
              for (
                var r = o(t), p = arguments.length, u = 1, l = s.f, h = n.f;
                p > u;
          ...
          return (
            ...
            (t.prototype._splitTweenOptions = function (t) {
              ...
              for (
                ...
                var a = e[n];
                _[a] &&
                  (null != t[a] && ((r[a] = t[a]), (i = !0)), delete t[a]);
              }
