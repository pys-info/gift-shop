(function ($) {
  ...
  $(".category-banner1-carousel").slick({
    ...
    slidesToScroll: 1,
    prevArrow:
      '<button class="slick-prev"><i class="fa fa-long-arrow-left"></i></button>',
    nextArrow:
      '<button class="slick-next"><i class="fa fa-long-arrow-right"></i></button>',
    responsive: [
      {
        breakpoint: 991,
        settings: {
  ...
  const instagramToken =
    "IGQVJVai1mRVNkalVIRDdOVTJ4WDBReENPZAndCNGNIT094d0ZAsX2NhYUxSbUFxQU9JbjlyVUkyRU5uRUxmWVBOU0tyWFpfb2lCMm1RUzVSTWgzN3pIb2Q4UjdiTlVZAWWZAOVzBINmlNc2VpUmZA3MGsxUAZDZD";
  if ($(".instafeed").length) {
    $(".instafeed").each(function () {
      const $id = $(this).attr("id"),
        feed = new Instafeed({
          ...
          target: $id,
          template:
            '<a class="instafeed-item" href="{{link}}"><img title="{{caption}}" src="{{image}}" /><i class="fab fa-instagram"></i></a>',
          limit: 12,
          after: function () {
